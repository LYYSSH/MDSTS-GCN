...
def train():
    ...
    for epoch in range(args.n_epochs):
        ...
        if (epoch + 1) % 100 == 0:
            ...
            plt.plot(train_loss, color=palette[0], label='Train loss',linewidth=2,linestyle='--',fontsize=18)
            plt.plot(val_loss, color=palette[1], label='Val loss', linewidth=2,linestyle='--',fontsize=18)
